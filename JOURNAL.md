...
- [1] I continued fiddling with the layout of the printer, and I think I have decided how I want it to go. I am laying out a footprint in Fusion and trying to make everything fit nicely. I have decided on linear rails for all axes and am now planning how to build it.<img width="733" height="818" alt="image" src="https://github.com/user-attachments/assets/2f3b04ab-fa09-4a03-b98d-3e589f4ae78f" />
  

- [2] I worked on getting this into Fusion, figuring out spacing and rail sizes. Then Fusion crashed. I lost my work. At least I was writing down my measurements as I went so I could recreate what I had. Now I have a basic frame and am looking at what extruder to use. I am leaning toward the picolino.<img width="852" height="742" alt="image" src="https://github.com/user-attachments/assets/65857724-db39-4e36-9dd5-520fd65470af" />
